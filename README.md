# Boas vindas ao repositório do Projeto JavaScript Functions!
# Sumário
 ...
 - [Requisitos do projeto](#requisitos-do-projeto)
    ...
    `Requisitos bônus:`
    - [11 - Crie uma função de Condição de existência de um triângulo](#11---crie-uma-função-de-condição-de-existência-de-um-triângulo)
# Habilidades
...
### 11 - Crie uma função de Condição de existência de um triângulo
